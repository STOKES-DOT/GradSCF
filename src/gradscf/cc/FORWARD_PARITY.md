...
| EOM, iterative triples/quadruples, local/F12 | Missing | Subsequent stages; no placeholder APIs |
...
2. Add EOM-EE/IP/EA then SF, left/right states, transition densities and oscillator
   strengths. The nonsymmetric eigensolver and its response belong in
