"""PySCF-style restricted ground-state CC facades, without solver copies."""

from dataclasses import fields
import hashlib
import numpy as np
from ..scf.reference import reference_from_source, RestrictedReference
...
class CC:
    ...
    def _physical_state_key(self):
        ...
        return (
            self.method,
            frozen_indices(ref.h1.shape[0], ref.nocc, self.frozen),
